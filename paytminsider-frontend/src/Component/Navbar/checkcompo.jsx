  ...
  return (
    ...
    {status ? (
      <div style={{display:'flex', alignItems:'center', justifyContent:'center', height:'100vh'}}>
        <img src={LoaderImg} alt="loader" style={{height:'50px', width:'50px'}}/>
      </div>
    ) : (
    <div>
      <Navbar />
      <div className="sm:mx-[10px] md:mx-[50px] lg:mx-[150px]">
        <div className="grid grid-cols-3 gap-5 grid-flow-row-dense pt-[7rem] ">
          ...
          <div className="col-span-1 h-100 border rounded-[8px] p-3 flex flex-col justify-between gap-2">
          ...
          <div className="col-span-1 border rounded-[8px] p-3">
            <div className="flex flex-col justify-between h-[100%] gap-2">
              ...
              <div className="flex justify-start items-center gap-3">
                ...
                <div>
                  <div className="text-[#7a7c82] text-[13px]">For Age(s)</div>
                  <div>{data.age}</div>
                </div>
              </div>
              <div className="flex justify-start items-center gap-3">
              ...
              >
                ...
                <AccordionDetails>
                  <Typography>
                    ...
                    <li>
                      No refunds on purchased ticket are possible, even in case
                      of any rescheduling.
                    </li>
                    <li>
                      Security procedures, including frisking remain the right
                      of the management.
                    </li>
                    <li>
                      No dangerous or potentially hazardous objects including
                      but not limited to weapons, knives, guns, fireworks,
                      helmets, lazer devices, bottles, musical instruments will
                      be allowed in the venue and may be ejected with or without
                      the owner from the venue.
                    </li>
                    <li>
                      The sponsors/performers/organizers are not responsible for
                      any injury or damage occurring due to the event. Any
                      claims regarding the same would be settled in courts in
                      Mumbai.
                    </li>
                    <li>
